...
- (void)startInstall:(RootViewController*)root ignoreRoot:(BOOL)ignoreRoot {
    ...
    NSString* urlString_startInstall = [Utils getGeodeReleaseURL];
    dispatch_async(dispatch_get_main_queue(), ^{
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Debug URL" message:urlString_startInstall preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction* okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
        [alert addAction:okAction];
        [_root presentViewController:alert animated:YES completion:nil];
    });
    NSURLRequest* request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString_startInstall]];
                            ...
                            if ([assetName isKindOfClass:[NSString class]]) {
                                if ([assetName hasSuffix:@"-ios.zip"]) {
                                    ...
                                    if ([downloadURL isKindOfClass:[NSString class]]) {
                                        dispatch_async(dispatch_get_main_queue(), ^{
                                            UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Debug URL" message:downloadURL preferredStyle:UIAlertControllerStyleAlert];
                                            UIAlertAction* okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
                                            [alert addAction:okAction];
                                            [_root presentViewController:alert animated:YES completion:nil];
...
- (void)checkUpdates:(RootViewController*)root download:(BOOL)download {
    ...
    _root = root;
    NSString* urlString_checkUpdates = [Utils getGeodeReleaseURL];
    dispatch_async(dispatch_get_main_queue(), ^{
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Debug URL" message:urlString_checkUpdates preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction* okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
        [alert addAction:okAction];
        [_root presentViewController:alert animated:YES completion:nil];
    });
    NSURLRequest* request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString_checkUpdates]];
...
- (void)checkLauncherUpdates:(RootViewController*)root {
    ...
    NSString* urlString_checkLauncher = [Utils getGeodeLauncherURL];
    dispatch_async(dispatch_get_main_queue(), ^{
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Debug URL" message:urlString_checkLauncher preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction* okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
        [alert addAction:okAction];
        [_root presentViewController:alert animated:YES completion:nil];
    });
    NSURLRequest* request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString_checkLauncher]];
    NSURLSession* session = [NSURLSession sessionWithConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration]];
    NSURLSessionDataTask* dataTask = [session dataTaskWithRequest:request completionHandler:^(NSData* data, NSURLResponse* response, NSError* error) {
        if (error) {
            return dispatch_async(dispatch_get_main_queue(), ^{
...
- (void)verifyChecksum {
    ...
    NSString* urlString_verify = @"https://jinx.firee.dev/gode/version.txt";
    dispatch_async(dispatch_get_main_queue(), ^{
        UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Debug URL" message:urlString_verify preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction* okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:nil];
        [alert addAction:okAction];
        [_root presentViewController:alert animated:YES completion:nil];
    });
    NSURLRequest* request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString_verify]];
    NSURLSession* session = [NSURLSession sessionWithConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration]];
    NSURLSessionDataTask* dataTask = [session dataTaskWithRequest:request completionHandler:^(NSData* data, NSURLResponse* response, NSError* error) {
        if (error) {
            return dispatch_async(dispatch_get_main_queue(), ^{
